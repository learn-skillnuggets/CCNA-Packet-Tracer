...
### Module 1: Network Fundamentals (Labs 01-06)
...
### Module 3: IP Connectivity - Routing (Labs 14-18)
- Static Routing
...
### Module 4: IP Services (Labs 19-24, 31)
...
### Module 6: Automation & Programmability (Labs 32-34)
...
2. Open the lab file in your text editor
3. Build the topology in Cisco Packet Tracer using the PDF diagram
4. Apply initial configurations (copy-paste provided configs)
5. Complete student instructions (the actual lab work)
6. Verify your work using provided verification commands
7. Check your solution against the final configuration
